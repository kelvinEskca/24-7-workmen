...
const ArtisanList = () => {
    ...
    const handleDelete = async (i) =>{
        const id = i._id;
        try{
            const res = await axios.post(`http://localhost:5000/api/artisans/delete/${id}`,{
                id:id
            },{ headers:{token:token} });
            if(res.status === 200){
                        ...
                        <div className="boxes">
                            ...
                            <div className="tabs-wrapper">
                                <div className="tabs">
                                    ...
                                    <Link to="/artisanList"><div className="tab active"><h3 className="heading">View Artisans</h3></div></Link>
